...
@register_model
def speaker_vgg_cct_end_to_end_gender_corpus_14_7x2_224(pretrained=False, progress=False, img_size=224, positional_embedding='learnable',
                             num_classes=10,
                             ...
                             *args, **kwargs):
    return speaker_vgg_cct_end_to_end_14(arch='speaker_vgg_cct_end_to_end_gender_corpus_14_7x2_224', pretrained=pretrained, progress=progress,
                             pretrained_arch="cct_14_7x2_224",
                             kernel_size=7, n_conv_layers=2,
                             img_size=img_size, positional_embedding=positional_embedding,
...
@register_model
def speaker_vgg_cct_end_to_end_gender_14_7x2_224(pretrained=False, progress=False, img_size=224, positional_embedding='learnable',
                             num_classes=10,
                             gender_embedder_path="./output/train/gender-models/cct_14_7x2_224-pretrained/model_best.pth.tar",
                             *args, **kwargs):
    return speaker_vgg_cct_end_to_end_14(arch='speaker_vgg_cct_end_to_end_gender_14_7x2_224', pretrained=pretrained, progress=progress,
                             pretrained_arch="cct_14_7x2_224",
                             kernel_size=7, n_conv_layers=2,
                             img_size=img_size, positional_embedding=positional_embedding,
                             gender_embedder_path=gender_embedder_path,
...
@register_model
def speaker_vgg_cct_end_to_end_corpus_14_7x2_224(pretrained=False, progress=False, img_size=224, positional_embedding='learnable',
                             num_classes=10,
                             corpus_embedder_path="./output/train/corpus-models/cct_14_7x2_224-pretrained/model_best.pth.tar",
                             *args, **kwargs):
    return speaker_vgg_cct_end_to_end_14(arch='speaker_vgg_cct_end_to_end_corpus_14_7x2_224', pretrained=pretrained, progress=progress,
                             pretrained_arch="cct_14_7x2_224",
                             kernel_size=7, n_conv_layers=2,
                             img_size=img_size, positional_embedding=positional_embedding,
                             corpus_embedder_path=corpus_embedder_path,
...
@register_model
def speaker_vgg_cct_end_to_end_speaker_token_14_7x2_224(pretrained=False, progress=False, img_size=224, positional_embedding='learnable',
                             num_classes=10,
                             *args, **kwargs):
    return speaker_vgg_cct_end_to_end_14(arch='speaker_vgg_cct_end_to_end_speaker_token_14_7x2_224', pretrained=pretrained, progress=progress,
                             pretrained_arch="cct_14_7x2_224",
                             kernel_size=7, n_conv_layers=2,
                             img_size=img_size, positional_embedding=positional_embedding,
                             num_classes=num_classes,

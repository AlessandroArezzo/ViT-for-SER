...
from .utils.transformers import TransformerEncoderLayer, TransformerEncoderScndLevelLayer
...
@register_model
def speaker_vgg_cct_7_8x2_32(pretrained=False, progress=False, img_size=32, positional_embedding='learnable',
                             num_classes=10,
                             *args, **kwargs):
    return speaker_vgg_cct_7(arch='speaker_vgg_cct_7_8x2_32', pretrained=pretrained, progress=progress,
                             pretrained_arch="cct_7_3x1_32_c100",
                             kernel_size=8, n_conv_layers=2,
...
@register_model
def speaker_vgg_corpus_cct_14_7x2_224(pretrained=False, progress=False, img_size=224, positional_embedding='learnable',
                         num_classes=10,
                         corpus_embedder_path="./output/train/corpus-models/cct_14_7x2_224-pretrained/model_best.pth.tar",
                        *args, **kwargs):
    return speaker_vgg_cct_14(arch='speaker_vgg_corpus_cct_14_7x2_224', pretrained=pretrained, progress=progress,
                             pretrained_arch="cct_14_7x2_224",
                             kernel_size=7, n_conv_layers=2,
                             img_size=img_size, positional_embedding=positional_embedding,
                             num_classes=num_classes,
...
@register_model
def speaker_vgg_gender_corpus_cct_14_7x2_224(pretrained=False, progress=False, img_size=224, positional_embedding='learnable',
                         num_classes=10,
                         gender_embedder_path="./output/train/gender-models/cct_14_7x2_224-pretrained/model_best.pth.tar",
                         corpus_embedder_path="./output/train/corpus-models/cct_14_7x2_224-pretrained/model_best.pth.tar",
                        *args, **kwargs):
    return speaker_vgg_cct_14(arch='speaker_vgg_gender_corpus_cct_14_7x2_224', pretrained=pretrained, progress=progress,
                             pretrained_arch="cct_14_7x2_224",
                             kernel_size=7, n_conv_layers=2,
                             img_size=img_size, positional_embedding=positional_embedding,
                             num_classes=num_classes,
...
@register_model
def speaker_vgg_cct_14_7x2_224_pooling(pretrained=False, progress=False, img_size=32, positional_embedding='learnable',
                             num_classes=10,
                             *args, **kwargs):
    return speaker_vgg_cct_14(arch='speaker_vgg_cct_14_7x2_224_pooling', pretrained=pretrained, progress=progress,
                             pretrained_arch="cct_14_7x2_224",
                             kernel_size=7, n_conv_layers=2,
                             img_size=img_size, positional_embedding=positional_embedding,
                             num_classes=num_classes,
...
@register_model
def speaker_vgg_cct_14_7x2_224_concat(pretrained=False, progress=False, img_size=32, positional_embedding='learnable',
                             num_classes=10,
                             *args, **kwargs):
    return speaker_vgg_cct_14(arch='speaker_vgg_cct_14_7x2_224_concat', pretrained=pretrained, progress=progress,
                             pretrained_arch="cct_14_7x2_224",
                             kernel_size=7, n_conv_layers=2,
                             img_size=img_size, positional_embedding=positional_embedding,
                             num_classes=num_classes,
...
@register_model
def speaker_vgg_cct_7_3x1_32_concat(pretrained=False, progress=False, img_size=32, positional_embedding='learnable',
                             num_classes=10,
                             *args, **kwargs):
    return speaker_vgg_cct_7(arch='speaker_vgg_cct_7_3x1_32_concat', pretrained=pretrained, progress=progress,
                             pretrained_arch="cct_7_3x1_32_c100",
                             kernel_size=3, n_conv_layers=1,
                             img_size=img_size, positional_embedding=positional_embedding,
                             num_classes=num_classes,
...
@register_model
def speaker_vgg_cct_7_3x1_32_reg(pretrained=False, progress=False, img_size=32, positional_embedding='learnable',
                             num_classes=10,
                             *args, **kwargs):
    return speaker_vgg_cct_7(arch='speaker_vgg_cct_7_3x1_32', pretrained=pretrained, progress=progress,
                             pretrained_arch="cct_7_3x1_32_c100",
...
@register_model
def speaker_vgg_gender_cct_7_3x1_32(pretrained=False, progress=False, img_size=32, positional_embedding='learnable',
                         num_classes=10,
                         gender_embedder_path="./output/train/gender-models/mcct_7_3x1_32_c100-pretrained/model_best.pth.tar",
                        *args, **kwargs):
    return speaker_vgg_cct_7(arch='speaker_vgg_gender_cct_7_3x1_32', pretrained=pretrained, progress=progress,
                             pretrained_arch="cct_7_3x1_32_c100",
                             kernel_size=3, n_conv_layers=1,
                             img_size=img_size, positional_embedding=positional_embedding,
                             num_classes=num_classes,
...
@register_model
def speaker_vgg_corpus_cct_7_3x1_32(pretrained=False, progress=False, img_size=32, positional_embedding='learnable',
                         num_classes=10,
                         corpus_embedder_path="./output/train/corpus-models/mcct_7_3x1_32_c100-pretrained/model_best.pth.tar",
                        *args, **kwargs):
    return speaker_vgg_cct_7(arch='speaker_vgg_corpus_cct_7_3x1_32', pretrained=pretrained, progress=progress,
                             pretrained_arch="cct_7_3x1_32_c100",
                             kernel_size=3, n_conv_layers=1,
                             img_size=img_size, positional_embedding=positional_embedding,
                             num_classes=num_classes,
...
@register_model
def speaker_vgg_gender_corpus_cct_7_3x1_32(pretrained=False, progress=False, img_size=32, positional_embedding='learnable',
                         num_classes=10,
                         gender_embedder_path="./output/train/gender-models/mcct_7_3x1_32_c100-pretrained/model_best.pth.tar",
                         corpus_embedder_path="./output/train/corpus-models/mcct_7_3x1_32_c100-pretrained/model_best.pth.tar",
                        *args, **kwargs):
    return speaker_vgg_cct_7(arch='speaker_vgg_gender_corpus_cct_7_3x1_32', pretrained=pretrained, progress=progress,
                             pretrained_arch="cct_7_3x1_32_c100",
                             kernel_size=3, n_conv_layers=1,
                             img_size=img_size, positional_embedding=positional_embedding,
                             num_classes=num_classes,
...
@register_model
def speaker_vgg_cct_7_3x1_32_project_emo(pretrained=False, progress=False, img_size=32, positional_embedding='learnable',
                             num_classes=10,
                             *args, **kwargs):
    return speaker_vgg_cct_7(arch='speaker_vgg_cct_7_3x1_32_project_emo', pretrained=pretrained, progress=progress,
                             pretrained_arch="cct_7_3x1_32_c100",
                             kernel_size=3, n_conv_layers=1,
                             img_size=img_size, positional_embedding=positional_embedding,
                             num_classes=num_classes,
...
def speaker_vgg_cct_7_3x1_32_pooling(pretrained=False, progress=False, img_size=32, positional_embedding='learnable',
                             num_classes=10,
                             *args, **kwargs):
    return speaker_vgg_cct_7(arch='speaker_vgg_cct_7_3x1_32_pooling', pretrained=pretrained, progress=progress,
                             pretrained_arch="cct_7_3x1_32_c100",
                             kernel_size=3, n_conv_layers=1,
                             img_size=img_size, positional_embedding=positional_embedding,
                             num_classes=num_classes,
...
@register_model
def speaker_vgg_cct_7_3x1_32_learnable_pe(pretrained=False, progress=False, img_size=32, positional_embedding='learnable',
                             num_classes=10,
                             *args, **kwargs):
    return speaker_vgg_cct_7(arch='speaker_vgg_cct_7_3x1_32_learnable_pe', pretrained=pretrained, progress=progress,
                             pretrained_arch="cct_7_3x1_32_c100",
                             kernel_size=3, n_conv_layers=1,
                             img_size=img_size, positional_embedding=positional_embedding,
                             num_classes=num_classes,
...
@register_model
def speaker_vgg_cct_7_3x1_32_sine_pe(pretrained=False, progress=False, img_size=32, positional_embedding='learnable',
                             num_classes=10,
                             *args, **kwargs):
    return speaker_vgg_cct_7(arch='speaker_vgg_cct_7_3x1_32_sine_pe', pretrained=pretrained, progress=progress,
                             pretrained_arch="cct_7_3x1_32_c100",
                             kernel_size=3, n_conv_layers=1,
                             img_size=img_size, positional_embedding=positional_embedding,
                             num_classes=num_classes,
                             n_layers_scnd_transformer=1,
                             n_heads_scnd_transformer=1,
                             positional_embedding_scnd_transformer='sine',
                             *args, **kwargs)
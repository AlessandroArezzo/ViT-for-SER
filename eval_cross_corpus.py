...
from timm.data import create_loader, resolve_data_config, create_dataset, ImageDataset
...
def main():
    ...
    for idx, folder in enumerate(folders):
        ...
        performance_output = os.path.join(output_dir, os.path.basename(folder))
        ...
        eval_csv = os.path.join(args.data_test_path, "dataset.csv")


        eval_model_path = os.path.join(folder, "model_best.pth.tar")
        ...
        model_stats = {"accuracy": str(accuracy_folder * 100),
                       "micro_precision": str(micro_precision_folder * 100),
                       "micro_recall": str(micro_recall_folder * 100),
        ...
        macro_precision_tot += macro_precision_folder
        micro_recall_tot += micro_recall_folder
        ...
        save_confusion_matrix(cm_folder, class_labels_in_order, cm_output_file_path)
